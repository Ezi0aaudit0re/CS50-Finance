...
INSERT INTO `histories` VALUES (0,16,'bought','A',41,3,'2016-04-19 23:54:07'),(0,16,'sold','A',41,14,'2016-04-19 23:55:48');
...
CREATE TABLE `portfolios` (
  ...
  `user_id` int(11) NOT NULL,
  UNIQUE KEY `symbol` (`symbol`,`user_id`),
  UNIQUE KEY `symbol_2` (`symbol`,`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `portfolios` VALUES (0,'G',2,16),(0,'GOOG',4,16);
...
-- Dump completed on 2016-04-20  1:00:02
